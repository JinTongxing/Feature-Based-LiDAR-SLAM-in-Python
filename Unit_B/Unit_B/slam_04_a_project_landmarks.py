...
if __name__ == '__main__':
    ...
    scanner_displacement = 30.0 # scanner to vehicle
    ticks_to_mm = 0.349
    robot_width = 150.0

    # The constants we used for the cylinder detection in our scan.    
    minimum_valid_distance = 20.0 #valid measurement
    depth_jump = 100.0 #derivative
    ...
    logfile = LegoLogfile()
    logfile.read("robot4_motors.txt") # store in motor_ticks
    logfile.read("robot4_scan.txt") # store in scan_data
    ...
    for i in xrange(len(logfile.scan_data)):
        ...
        write_cylinders(out_file, "D C", cartesian_cylinders) #defined before
