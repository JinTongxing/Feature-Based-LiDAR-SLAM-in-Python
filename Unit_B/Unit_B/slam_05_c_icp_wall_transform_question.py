...
# This is an ICP algorithm. Iterative Closest Points.
...
def get_icp_transform(world_points, iterations):
    ...
    for j in xrange(iterations):
        world_points_st = [apply_transform(overall_trafo, p) for p in world_points]
        left, right = get_corresponding_points_on_wall(world_points_st)
